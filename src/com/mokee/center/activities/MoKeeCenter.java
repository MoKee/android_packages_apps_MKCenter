...
public class MoKeeCenter extends AppCompatActivity {
    ...
    public void donateOrUnlockFeatureDialog(final boolean isDonate) {
        ...
        if (isDonate) {
            ...
            mRequest.setText(paid >= Constants.DONATION_REQUEST ? getString(R.string.unlock_features_verify_rom_title, mSeekBar.getProgress() - paid.intValue())
                    : getString(R.string.unlock_features_ota_title, mSeekBar.getProgress() - paid.intValue()));
        }
