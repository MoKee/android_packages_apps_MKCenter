...
public class MoKeeCenter extends AppCompatActivity {
    ...
    public void donateOrUnlockFeatureDialog(final boolean isDonate) {
        ...
        if (isDonate) {
            ...
            mSeekBar.setProgress(Constants.DONATION_REQUEST);
            mRequest.setText(paid >= Constants.DONATION_REQUEST ? getString(R.string.unlock_features_verify_rom_title, mSeekBar.getProgress() - paid)
                    : getString(R.string.unlock_features_ota_title, mSeekBar.getProgress() - paid));
        }
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (isDonate) {
                    ...
                    if (paid >= Constants.DONATION_REQUEST || progress > Constants.DONATION_REQUEST) {
                        ...
                        mRequest.setText(getString(R.string.unlock_features_verify_rom_title, mSeekBar.getProgress() - paid));
                    } else {
                        seekBar.setProgress(Constants.DONATION_REQUEST);
                        mRequest.setText(getString(R.string.unlock_features_ota_title, mSeekBar.getProgress() - paid));
                    }
                }
            }
        });
