...
public class DeviceRegistrationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Utils.getDefaultSharedPreferences().edit().putStringSet(Constants.UNIQUE_REGISTRATION_IDS, unique_ids).apply();
        stopSelf();
    }
}
